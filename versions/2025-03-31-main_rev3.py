...
class MainApp(tk.Tk):
    def __init__(self):
        ...
        print("Keyboard shortcuts created")
    ...
    def select_folder(self):
        ...
        print("Created \"Archived\" and \"Starred\" folders")

        self.image_files_first = [
            f for f in os.listdir(self.current_folder)
            if f.lower().endswith(('.png', '.jpg', '.jpeg', '.gif', '.bmp'))
        ]

        
        print("All images were indexed")

        # self.image_display.select_new_folder(self.current_folder)
        self.control_panel.select_new_folder(folder)
    ...
    def setup_keyboard_shortcuts(self):
        keyboard.on_press_key("o", lambda _: self.select_folder() if keyboard.is_pressed("ctrl") else None)
...
class ImageDisplay(ttk.Frame):
    ...
    def select_new_folder(self, folder):
        self.current_folder = folder
...
class ControlPanel(ttk.Frame):
    def __init__(self, parent, image_display):
        ...
        self.star_button = ttk.Button(self, text="Sort Selected Folder", command=self.sort_folder)
